...
import Heading from '../../../compnents/atoms/Heading';
...
function Cards() {
  ...
  return (
    <div className="container mb-[50px] relative mt-[50px] flex flex-wrap justify-between gap-[20px] w-full">
      <div className="box-outer w-full sm:w-[48%] md:w-[31%]">
        <div className="box-skill flex flex-col gap-[25px] px-[30px] py-[50px] rounded-[10px] bg-customGray w-full"
          style={style}
      ...
      <div className="box-outer w-full sm:w-[48%] md:w-[31%]">
        ...
        >
          ...
          <Heading level="3">Creative Work</Heading>
